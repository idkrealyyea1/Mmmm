...
const T = {
  // === Global ===
  "brand_name":        { ar: "مارشميلو",              en: "MARSHMALLO" },
  ...
  // === Home Page ===
  "hero_title":        { ar: "MARSHMALLO",            en: "MARSHMALLO" },
  ...
  "about_story":       { ar: "تأسست Marshmallo لتكون الوجهة الأولى للمناسبات الأنيقة والتصوير الاحترافي في أجواء فاخرة ومميزة. نؤمن بأن كل لحظة تستحق أن تُخلّد بأجمل صورة، وكل مناسبة تستحق أجواء استثنائية.",
                         en: "Marshmallo was founded to be the premier destination for elegant events and professional photography in a luxurious atmosphere. We believe every moment deserves to be captured beautifully, and every occasion deserves an exceptional setting." },
  ...
  "about_why_title":   { ar: "لماذا مارشميلو؟",       en: "Why Marshmallo?" },
